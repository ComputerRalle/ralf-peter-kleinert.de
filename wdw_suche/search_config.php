...
$alledirs = true; 		// dann setze $alledirs = true; ACHTUNG: dies verlangsamt die Suche erheblich!
...
$show_ext = true;	// true: Suchergebnis mit Dateiendung anzeigen  - false: ohne Dateiendung. 
